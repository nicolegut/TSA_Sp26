...
plot_grid(
  autoplot(Acf(Model_10)),
  autoplot(Acf(Model_01)),
  autoplot(Acf(Model_11)))
...
plot_grid(
  autoplot(Pacf(Model_10)),
  autoplot(Pacf(Model_01)),
  autoplot(Pacf(Model_11)))
...
#plotting the ACFs
plot_grid(
  autoplot(Acf(Model_10_n1k)),
  autoplot(Acf(Model_01_n1k)),
  autoplot(Acf(Model_11_n1k)))

#plotting the PACFs
plot_grid(
  autoplot(Pacf(Model_10_n1k)),
  autoplot(Pacf(Model_01_n1k)),
  autoplot(Pacf(Model_11_n1k)))
