...
#will give you the error: Error in stats::arima(x = x, order = order, seasonal = seasonal, include.mean = include.mean,  : non-stationary AR part from CSS
...
## can only compare models when fitting the same time series to them!
## because the dataset is different --> cannot compare aic's
...
** adding the seasonal component back to the observed and the ARIMA series
