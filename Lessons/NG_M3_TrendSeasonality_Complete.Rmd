...
```
The spearman is less than one/ p value is less than 0.5 --> there is a deterministic trend in the dataset / rejecting null hypothesis. When looking at seasonal data --> might not be an overall trend but could be seasonal trends (colds getting colder and hots getting hotter etc)
