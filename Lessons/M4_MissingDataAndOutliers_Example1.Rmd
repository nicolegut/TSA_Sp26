...
#overall 37 years --> observations fill all months for all years
#a check for if there are missing values/ months in the time series
#if there were missing values --> then the data for the months would be pushed into other months + not fill up the rows like they are supposed to. 
```
