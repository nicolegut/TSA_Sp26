...
plot(naive_seas)
#^ will only repeat what happened in the last year with increasing CI intervals
#^^will not consider trend
...
plot(naive_deseas)
#will not worry about seasonality and will just plot the last value over and over
...
SMA_deseas <- smooth::sma(deseasonal_allsectors_price, h = 36, holdout = FALSE, silent =  FALSE)
